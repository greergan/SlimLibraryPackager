# ---------------------------------------------------------------------------
# Toolchain: macOS arm64 (Apple Silicon)
...
#                   (default: aarch64-apple-darwin23)
# ---------------------------------------------------------------------------
...
set(DARWIN_TRIPLE "aarch64-apple-darwin23" CACHE STRING "osxcross target triple")

if(NOT EXISTS "${OSXCROSS_ROOT}")
    message(FATAL_ERROR
        "macos-arm64 toolchain: OSXCROSS_ROOT not found: '${OSXCROSS_ROOT}'\n"
